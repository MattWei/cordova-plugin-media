...
public class ExtAudioRecorder {
	...
	public static ExtAudioRecorder getInstanse() {
		return ExtAudioRecorder.getInstance(0, AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT);
	}

	public static ExtAudioRecorder getInstance(int sampleRate, int channels, int encoding) {
		...
		int i = 0;
		do {
			result = new ExtAudioRecorder(AudioSource.MIC, processedSampleRates[i], channels, encoding);
